...
public class CustomerZoneSecurityFilter implements Filter{
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		System.out.println("customer filter has been instanciated");
	}
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if (letGo) {
			...
			resp.sendRedirect(req.getContextPath()+"/pages/login.esprit");
		}
		
	}

	public void destroy() {
		System.out.println("customer filter will soon be destroyed");
	}
